...
export const validateTournamentId = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const validatePlayer1 = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const validatePlayer2 = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const validateDifferentPlayers = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const validateMatchOrder = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
