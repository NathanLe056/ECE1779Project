...
import { validateTournamentMemberId, validateTournamentId, validateUserId, validateRole, validateRanking, validateUniqueTournamentMember, validateTournamentCapacity, } from "../middleware/tournamentmembertable.js";
const router = Router();
// CREATE tournament member
router.post("/", requireAuth, validateTournamentId, validateUserId, validateRole, validateRanking, validateUniqueTournamentMember, validateTournamentCapacity, async (req, res) => {
    try {
